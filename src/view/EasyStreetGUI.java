...
public class EasyStreetGUI extends JFrame implements ActionListener {
    ...
    // constants to capture screen dimensionsn
    /** A ToolKit. */
    ...
    private void drawDebugInfo(final Graphics2D theGraphics, final int theX, final int theY) {
        ...
        if (myDebugFlag) {
            ...
            final int leftx = theX * 10;
            final int topy = theY * 10;
            theGraphics.drawString("|__", leftx, topy + DEBUG_OFFSET);
    ...
    private class EasyStreetPanel extends JPanel {
        ...
        public void paintComponent(final Graphics theGraphics) {
            ...
            System.out.println("come inside paintComponent");
            g2.setStroke(STROKE);
