...
public class Maze extends JFrame
{
    ...
    private static enum Dir { NORTH, EAST, SOUTH, WEST }; // 0, 1, 2, 3
...
//        System.out.println();
        ...
        while (!path.empty())
        {
            ...
            if (neighbors.size() > 0)
            {
                ...
                if (!next.visited) // undiscovered cell->mark and continue
                {
                    ...
                    if (!goalFound) // haven't found dest, keep digging for solution
    ...
    class Cell
    {
        ...
        {
            return "(" + x + ", " + y + "), " + "Visited: " + visited + ", isSolution: " + isSolution
                    + ", northWall: " + northWall + ", eastWall: " + eastWall
                    + ", southWall: " + southWall + ", westWall: " + westWall;
        }
    }
}
